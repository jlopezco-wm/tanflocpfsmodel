...
get_rds <- function(file) {
  ...
  base <- "https://raw.githubusercontent.com/jlopezco-wm/coagulation/main/"
...
pfs_rem <- get_rds("tanfloc_rem.rds") #Model with pfs data
